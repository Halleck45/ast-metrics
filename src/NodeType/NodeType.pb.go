...
type Stmt struct {
	...
	//	*Stmt_StmtNamespace
	//	*Stmt_StmtDecisionIf
	//	*Stmt_StmtDecisionElseIf
	//	*Stmt_StmtDecisionElse
	//	*Stmt_StmtDecisionCase
...
func (x *Stmt) GetStmtDecisionIf() *StmtDecisionIf {
	if x, ok := x.GetStmt().(*Stmt_StmtDecisionIf); ok {
		return x.StmtDecisionIf
	}
	return nil
}

func (x *Stmt) GetStmtDecisionElseIf() *StmtDecisionElseIf {
	if x, ok := x.GetStmt().(*Stmt_StmtDecisionElseIf); ok {
		return x.StmtDecisionElseIf
	}
	return nil
}

func (x *Stmt) GetStmtDecisionElse() *StmtDecisionElse {
	if x, ok := x.GetStmt().(*Stmt_StmtDecisionElse); ok {
		return x.StmtDecisionElse
	}
	return nil
}

func (x *Stmt) GetStmtDecisionCase() *StmtDecisionCase {
	if x, ok := x.GetStmt().(*Stmt_StmtDecisionCase); ok {
...
type Stmt_StmtDecisionIf struct {
	StmtDecisionIf *StmtDecisionIf `protobuf:"bytes,8,opt,name=stmtDecisionIf,proto3,oneof"`
}

type Stmt_StmtDecisionElseIf struct {
	StmtDecisionElseIf *StmtDecisionElseIf `protobuf:"bytes,9,opt,name=stmtDecisionElseIf,proto3,oneof"`
}

type Stmt_StmtDecisionElse struct {
	StmtDecisionElse *StmtDecisionElse `protobuf:"bytes,10,opt,name=stmtDecisionElse,proto3,oneof"`
}

type Stmt_StmtDecisionCase struct {
	StmtDecisionCase *StmtDecisionCase `protobuf:"bytes,11,opt,name=stmtDecisionCase,proto3,oneof"`
}
...
func (*Stmt_StmtDecisionIf) isStmt_Stmt() {}

func (*Stmt_StmtDecisionElseIf) isStmt_Stmt() {}

func (*Stmt_StmtDecisionElse) isStmt_Stmt() {}

func (*Stmt_StmtDecisionCase) isStmt_Stmt() {}
...
var file_proto_NodeType_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8e, 0x01, 0x0a, 0x07, 0x53, 0x74, 0x6d, 0x74, 0x55,
	0x73, 0x65, 0x12, 0x22, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x90, 0x01, 0x0a, 0x09, 0x53, 0x74, 0x6d, 0x74,
	0x43, 0x6c, 0x61, 0x73, 0x73, 0x12, 0x22, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	...
	0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x93, 0x01, 0x0a, 0x0c, 0x53,
	...
	0x22, 0x94, 0x01, 0x0a, 0x0d, 0x53, 0x74, 0x6d, 0x74, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61,
	...
	0x46, 0x69, 0x6c, 0x65, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x2b,
...
var file_proto_NodeType_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_proto_NodeType_proto_goTypes = []interface{}{
	...
	(*Stmt)(nil),               // 3: NodeType.Stmt
	(*StmtLocationInFile)(nil), // 4: NodeType.StmtLocationInFile
	(*StmtNamespace)(nil),      // 5: NodeType.StmtNamespace
	(*StmtUse)(nil),            // 6: NodeType.StmtUse
	(*StmtClass)(nil),          // 7: NodeType.StmtClass
	(*StmtFunction)(nil),       // 8: NodeType.StmtFunction
...
var file_proto_NodeType_proto_depIdxs = []int32{
	3,  // 0: NodeType.Stmts.stmts:type_name -> NodeType.Stmt
	1,  // 1: NodeType.File.stmts:type_name -> NodeType.Stmts
	4,  // 2: NodeType.Stmt.attributes:type_name -> NodeType.StmtLocationInFile
	7,  // 3: NodeType.Stmt.stmtClass:type_name -> NodeType.StmtClass
	8,  // 4: NodeType.Stmt.stmtFunction:type_name -> NodeType.StmtFunction
	9,  // 5: NodeType.Stmt.stmtInterface:type_name -> NodeType.StmtInterface
	10, // 6: NodeType.Stmt.stmtTrait:type_name -> NodeType.StmtTrait
	6,  // 7: NodeType.Stmt.stmtUse:type_name -> NodeType.StmtUse
	5,  // 8: NodeType.Stmt.stmtNamespace:type_name -> NodeType.StmtNamespace
	11, // 9: NodeType.Stmt.stmtDecisionIf:type_name -> NodeType.StmtDecisionIf
	12, // 10: NodeType.Stmt.stmtDecisionElseIf:type_name -> NodeType.StmtDecisionElseIf
	13, // 11: NodeType.Stmt.stmtDecisionElse:type_name -> NodeType.StmtDecisionElse
	14, // 12: NodeType.Stmt.stmtDecisionCase:type_name -> NodeType.StmtDecisionCase
	0,  // 13: NodeType.StmtNamespace.name:type_name -> NodeType.Name
	1,  // 14: NodeType.StmtNamespace.stmts:type_name -> NodeType.Stmts
	4,  // 15: NodeType.StmtNamespace.location:type_name -> NodeType.StmtLocationInFile
	0,  // 16: NodeType.StmtUse.name:type_name -> NodeType.Name
	1,  // 17: NodeType.StmtUse.stmts:type_name -> NodeType.Stmts
	4,  // 18: NodeType.StmtUse.location:type_name -> NodeType.StmtLocationInFile
	0,  // 19: NodeType.StmtClass.name:type_name -> NodeType.Name
	1,  // 20: NodeType.StmtClass.stmts:type_name -> NodeType.Stmts
	4,  // 21: NodeType.StmtClass.location:type_name -> NodeType.StmtLocationInFile
	0,  // 22: NodeType.StmtFunction.name:type_name -> NodeType.Name
	1,  // 23: NodeType.StmtFunction.stmts:type_name -> NodeType.Stmts
	4,  // 24: NodeType.StmtFunction.location:type_name -> NodeType.StmtLocationInFile
	0,  // 25: NodeType.StmtInterface.name:type_name -> NodeType.Name
	1,  // 26: NodeType.StmtInterface.stmts:type_name -> NodeType.Stmts
	4,  // 27: NodeType.StmtInterface.location:type_name -> NodeType.StmtLocationInFile
	0,  // 28: NodeType.StmtTrait.name:type_name -> NodeType.Name
	1,  // 29: NodeType.StmtTrait.stmts:type_name -> NodeType.Stmts
	4,  // 30: NodeType.StmtTrait.location:type_name -> NodeType.StmtLocationInFile
	1,  // 31: NodeType.StmtDecisionIf.stmts:type_name -> NodeType.Stmts
	4,  // 32: NodeType.StmtDecisionIf.location:type_name -> NodeType.StmtLocationInFile
	1,  // 33: NodeType.StmtDecisionElseIf.stmts:type_name -> NodeType.Stmts
	4,  // 34: NodeType.StmtDecisionElseIf.location:type_name -> NodeType.StmtLocationInFile
	1,  // 35: NodeType.StmtDecisionElse.stmts:type_name -> NodeType.Stmts
	4,  // 36: NodeType.StmtDecisionElse.location:type_name -> NodeType.StmtLocationInFile
	1,  // 37: NodeType.StmtDecisionCase.stmts:type_name -> NodeType.Stmts
	4,  // 38: NodeType.StmtDecisionCase.location:type_name -> NodeType.StmtLocationInFile
...
func file_proto_NodeType_proto_init() {
	...
	file_proto_NodeType_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Stmt_StmtClass)(nil),
		...
		(*Stmt_StmtDecisionIf)(nil),
		(*Stmt_StmtDecisionElseIf)(nil),
		(*Stmt_StmtDecisionElse)(nil),
		(*Stmt_StmtDecisionCase)(nil),
	}
	type x struct{}
