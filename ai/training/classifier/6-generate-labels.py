...
// This file is auto-generated from labels/roles.csv - DO NOT EDIT MANUALLY.
// To regenerate: python3 ai/training/classifier/6-generate-labels.py labels/roles.csv internal/analyzer/classifier/labels.go
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        print("Example: python3 6-generate-labels.py labels/roles.csv ../../internal/analyzer/classifier/labels.go")
        sys.exit(1)
