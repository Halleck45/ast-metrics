...
This script balances a dataset by programming language, labels, or both.
It saves the original dataset with a _full.csv suffix and creates a balanced version.

Usage:
    python 0-balance_dataset.py <input_csv> [--output=<output_csv>] [--strategy=<strategy>] [--min-samples=<n>]

Examples:
    # Balance by programming language
    python 0-balance_dataset.py dataset.csv --strategy=language

    # Balance by labels
    python 0-balance_dataset.py dataset.csv --strategy=label --min-samples=100

    # Balance by both language and labels
    python 0-balance_dataset.py dataset.csv --strategy=both
"""
import pandas as pd
import sys
import os
