...
Trains a RandomForest classifier to classify code snippets by architectural role.
Uses TF-IDF vectorization for text features, one-hot encoding for categorical features,
and weighted features for class names and programming languages.

Usage:
    python 3-train.py <dataset_csv> <model_output> <features_output> [--encoders-out=<path>]
